...
export default function UserManagementPage() {
  ...
  const handleDeactivate = async (user: User) => {
    ...
    // 🔒 Admin δεν μπορεί να απενεργοποιήσει άλλον admin
    ...
    // 🔒 Κανείς δεν μπορεί να απενεργοποιήσει τον εαυτό του
  ...
  const handleDelete = async (user: User) => {
    ...
    // 🔒 Admin δεν μπορεί να διαγράψει άλλον admin
    if (currentUser.role === BaseRole.ADMIN && user.role === BaseRole.ADMIN) {
      window.alert("Οι admin δεν μπορούν να διαγράφουν άλλους admin.");
      return;
    }

    // 🔒 Admin δεν μπορεί να διαγράψει τον εαυτό του
    if (currentUser.id === user.id) {
